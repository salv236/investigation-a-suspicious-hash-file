# investigation-a-suspicious-hash-file
...
Note: Use the <a href="https://www.coursera.org/learn/detection-and-response/exam/ghRgc/portfolio-activity-document-an-incident-with-an-incident-handlers-journal">incident handler's journal </a> you started in 
a previous activity
 to take notes during the activity and keep track of your findings. 

Note: You might recall <a href="https://www.coursera.org/learn/assets-threats-and-vulnerabilities/ungradedLti/SjSUK/activity-create-hash-values">creating SHA256 hashes </a> in the 
...
##Step2 - Review the details of the alert
...
##Step3 - Enter the fil hash into virustotal
...
##Step4 Analyze the virustotal report
...
##Step5 Determine whether the file is malicious
...
##Step6 Fill in the template with additional indiators of compromise
